...
class model_PHMM
  : public stan::model::model_base_crtp<model_PHMM> {
private:
        int N;
        std::vector<int> y;
        int m;
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(gamma_log<propto__>(lambda, 0.1, 0.01));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= m; ++j) {
                    ...
                    stan::model::assign(lp_p1, 
                                ...
                                (log_sum_exp(add(get_base1(log_A_tr, j, "log_A_tr", 1), lp)) + poisson_log(get_base1(y, i, "y", 1), get_base1(lambda, j, "lambda", 1))), 
