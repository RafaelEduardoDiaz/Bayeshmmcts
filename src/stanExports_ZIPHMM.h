...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(49, 47, "end", "model_ZIPHMM");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ZIPHMM
  : public stan::model::model_base_crtp<model_ZIPHMM> {
private:
        int N;
        std::vector<int> y;
        int m;
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("theta", "m", m);
        context__.validate_dims("parameter initialization", "theta", "vector_d", context__.to_vec(m));
        Eigen::Matrix<double, Eigen::Dynamic, 1> theta(m);
        size_t theta_j_1_max__ = m;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                theta = in__.simplex_constrain(m, lp__);
            else
                theta = in__.simplex_constrain(m);
            current_statement_begin__ = 12;
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                for (int j = 1; j <= m; ++j) {
                    ...
                    if (as_bool(logical_eq(get_base1(y, n, "y", 1), 0))) {
                        ...
                        stan::model::assign(lp_p1, 
                                    stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(lp_p1, stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), "lp_p1") + log_mix(get_base1(theta, j, "theta", 1), 0, poisson_log(0, get_base1(lambda, j, "lambda", 1)))), 
                                    "assigning variable lp_p1");
                    } else {
                        current_statement_begin__ = 41;
                        stan::model::assign(lp_p1, 
                                    stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(lp_p1, stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), "lp_p1") + (log1m(get_base1(theta, j, "theta", 1)) + poisson_log(get_base1(y, n, "y", 1), get_base1(lambda, j, "lambda", 1)))), 
                                    "assigning variable lp_p1");
                    }
                }
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> theta = in__.simplex_constrain(m);
        size_t theta_j_1_max__ = m;
        for (size_t j_1__ = 0; j_1__ < theta_j_1_max__; ++j_1__) {
